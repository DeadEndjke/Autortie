      ...
      <div className={a.registerform}>
        ...
        <div className={a.formgroup}>
          ...
          <input
            ...
            id="repeatpassword"
            onChange={(e) =>
              setRegdetails({ ...regdetails, repeatpassword: e.target.value })
            }
            value={regdetails.repeatpassword}
          />
        </div>
        <div className={a.policyprival}>
          <input type="checkbox" required />
          <span className={a.checkboxtext}>
            {" "}
            Я принимаю условия Пользовательского соглашения и даю своё согласие
            на обработку персональных данных на условиях, определенных Политикой
            конфиденциальности.
          </span>
        </div>
